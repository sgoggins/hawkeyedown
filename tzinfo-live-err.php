...
// Get info
//
$info_query = "SELECT *, last_count/state as tpm, (last_count/1)-$target_cnt as cnt_error FROM job WHERE job.state > 0 ORDER BY cnt_error DESC";
